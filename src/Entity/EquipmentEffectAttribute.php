...
#[ORM\Entity(repositoryClass: EquipmentEffectAttributeRepository::class)]
class EquipmentEffectAttribute
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'equipmenteffectattribute', targetEntity: EquipmentEffect::class)]
    ...
    public function addEquipmentEffect(EquipmentEffect $equipmentEffect): self
    {
        if (!$this->equipmentEffects->contains($equipmentEffect)) {
            ...
            $equipmentEffect->setEquipmenteffectattribute($this);
        }
    ...
    public function removeEquipmentEffect(EquipmentEffect $equipmentEffect): self
    {
        if ($this->equipmentEffects->removeElement($equipmentEffect)) {
            ...
            if ($equipmentEffect->getEquipmenteffectattribute() === $this) {
                $equipmentEffect->setEquipmenteffectattribute(null);
            }
        }
