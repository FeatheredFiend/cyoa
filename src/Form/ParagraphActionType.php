...
class ParagraphActionType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('paragraphactionattribute', EntityType::class,['class' => HeroAttribute::class, 'query_builder' => function (EntityRepository $er) {return $er->createQueryBuilder('paa')->orderBy('paa.id', 'ASC');}, 'choice_label' => 'name', 'label' => 'Paragraph Action Attribute'])
        ;
    }
